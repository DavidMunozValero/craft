...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run fairness-aware timetabling optimization."
    )
    parser.add_argument(
        "--seed", type=int, default=42, help="Random seed (default: 42)"
    )
    parser.add_argument(
        "--pop-size", type=int, default=20, help="Population size (default: 20)"
    )
    parser.add_argument(
        "--epoch", type=int, default=50, help="Number of epochs (default: 50)"
    )
    parser.add_argument(
        "--n-services",
        type=int,
    ...
    parser.add_argument(
        "--alpha", type=float, default=0.7, help="Revenue weight (default: 0.7)"
    )
    parser.add_argument(
        "--beta", type=float, default=0.3, help="Fairness weight (default: 0.3)"
    )
    parser.add_argument(
        "--supply",
        type=Path,
