...
def main() -> None:
    ...
    parser.add_argument("-n", "--n-services", type=int, default=25, help="Number of services to generate (default: 25)")
    parser.add_argument("--seed", type=int, default=42, help="Random seed (default: 42)")
    parser.add_argument("-o", "--output", type=Path, default=None, help="Output YAML path (default: data/results/supply_generator_seed<seed>.yaml)")
    ...
    parser.add_argument("--with-conflicts", action="store_true", help="Allow conflicts between services (default: without conflicts)")
    args = parser.parse_args()

    output_path = args.output or Path(f"data/results/supply_generator_seed{args.seed}.yaml")
